...
// //           {["Name", "Size", "Rate", "Gross Wt.", "Amount"].map((item) => (
// //             <View
// //               key={item}
...
//     const totalPrice = newProducts.reduce(
//       (acc, product) =>
//         Number(acc) + Number(product[isPurchase ? "purchase" : "sale"]?.net_price || 0),
//       0
//     );
...
//   // Check if there are products in the form value
//   const isProducts = formValue?.selectedProduct && formValue.selectedProduct.length > 0;
...
//     </SafeAreaView>
//   ) : (
//     <View className="space-y-4 pb-5 bg-white rounded-lg shadow-sm">
//       {/* Table */}
//       <View>
//         {/* Table Header */}
//         <View className="flex-row border-l border-t border-b border-gray-300 bg-gray-300">
//           {[
//             { label: "Name", flex: 2 },
//             { label: "Size", flex: 1 },
//             { label: "Rate", flex: 1.5 },
...
//             </View>
//           ))}
//           <View className="w-12 border-r border-gray-300" />
//         </View>
...
//               <View
//                 key={item.product_id || item.id || index}
//                 className={`flex-row border-b border-gray-300 items-center ${
//                   index % 2 === 0 ? "bg-gray-50" : "bg-white"
//                 }`}
//               >
//                 <Text
//                   style={{ flex: 2 }}
//                   className="border-r border-gray-300 px-2 py-3 text-sm text-center text-gray-600"
//                 >
//                   {item.name || "Unknown Product"}
//                 </Text>
//                 <Text
...
//                 >
//                   {currency}{" "}
//                   {typeof typeData.rate === "object"
//                     ? handleDigitsFix(typeData.rate?.price || 0)
//                     : handleDigitsFix(typeData.rate || 0)}
//                 </Text>
//                 <Text
//                   style={{ flex: 1 }}
//                   className="border-r border-gray-300 px-2 py-3 text-sm text-center text-gray-600"
//                 >
//                   {handleDigitsFix(typeData.gross_weight || 0)} g
//                 </Text>
//                 <Text
//                   style={{ flex: 1 }}
//                   className="border-r border-gray-300 px-2 py-3 text-sm text-center text-gray-600"
//                 >
//                   {handleDigitsFix(typeData.net_weight || 0)} g
//                 </Text>
//                 <Text
//                   style={{ flex: 1 }}
//                   className="border-r border-gray-300 px-2 py-3 text-sm text-center text-gray-600"
//                 >
//                   {handleDigitsFix(typeData.fine_weight || 0)} g
//                 </Text>
//                 <Text
//                   style={{ flex: 1.5 }}
//                   className="border-r border-gray-300 px-2 py-3 text-sm text-center text-gray-600"
...
//                   onPress={() => removeProduct(item.product_id || item.id)}
//                   activeOpacity={0.6}
//                   className="w-12 flex items-center justify-center py-3"
//                 >
...
//         ) : (
//           // No Products Message
//           <View className="py-6 border-b border-gray-200 bg-gray-50 items-center">
...
//         {/* Table Footer */}
//         <View className="flex-row items-center py-3 px-3 justify-end border-b border-gray-200 bg-gray-100">
//           <Text className="text-sm font-semibold pr-3 text-gray-700">Total:</Text>
//           <Text className="text-sm font-semibold text-gray-700">
//             {currency} {handleDigitsFix(formValue?.totalPrice || 0)}
//           </Text>
//         </View>
//       </View>
  ...
  return isAddItem ? (
    ...
    <View className="space-y-4 pb-5 rounded bg-white">
      ...
      <View>
        {/* thead */}
        <View className="flex-row border-l border-y border-gray-300 bg-gray-200">
          {["Name", "Size", "Rate", "Gross Wt.", "Net Wt.", "Fine Wt.", "Amount"].map((item) => (
            <View
              key={item}
              className="flex-1 py-2 px-1 border-r border-gray-300"
            >

...
// import ItemAssignment from '@/src/screens/groups/components/ItemAssignment';
...
//         // After updating contact info, navigate to ORInvoiceForm
//         if (isFromInvoice) {
//           const initialFormValue = {
//             client: {
//               label: updateValue.name,
...
//             selectedProduct: [],
//             totalPrice: "0",
//             invoiceType: invoiceHandler?.invoiceType || "order"
//           };

//           navigation.navigate("ORInvoiceForm", {
//             formValue: initialFormValue,
//             setFormValue: invoiceHandler?.setFormValue,
//             isPurchase: invoiceHandler?.isPurchase,
//             handleInputChange: invoiceHandler?.handleInputChange,
...
//   const handleItemAssign = (item, contact) => {
//     console.log(`Assigned ${item.name} to ${contact.name}`);
//   };
...
//         {!isFromInvoice && info?.id && (
//         <View className="mb-4">
//             <Text className="text-primary mb-3 font-semibold uppercase tracking-wider">
//               Assign Jewelry Items
//           </Text>
//             <ItemAssignment contactId={info.id} />
//         </View>
//         )}
